    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default=None, null=True, upload_to='images/user-profile')),
                ('email_active_code', models.CharField(blank=True, default=None, max_length=300, null=True)),
                ('bg_image', models.ImageField(blank=True, null=True, upload_to='images/user-profile')),
                ('theme_color', models.CharField(blank=True, default='blue', max_length=200, null=True)),
